...
public class ThumbNailReviewDto {
    ...
    public static ThumbNailReviewDto from(Review review) {
        return new ThumbNailReviewDto(review.getId(),review.getImages().get(0).getStoreImageName(), review.getRestaurant().getName(), review.getRestaurant().getForkCutlet().getName(), review.getRatingInfo().getOverall(),
