...
class ReviewTest {
    ...
    public void ReviewImageTest() throws Exception {
        ...
        Review review = new Review(userRepository.findByLoginId("user1").get(), restaurantRepository.findByName("식당1").get(), images, "it's sososo gooood","good", new RatingInfo(별점[2], 별점[2], 별점[2], 별점[2]));
        //when
