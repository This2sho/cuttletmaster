...
import static PorkCutlet.master.domain.QForkCutlet.*;
...
class ReviewRepositoryTest {
	...
	public void ReviewRepositoryTest() {
		...
		Review review = new Review(userRepository.findByLoginId("user1").get(),
			restaurantRepository.findByName("식당1").get(), images, "it's sososo gooood", "마싯쿤",
			new RatingInfo(FIVE, THREE, FOUR, ONE));
